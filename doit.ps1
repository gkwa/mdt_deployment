...
'@ | Out-File -encoding ASCII "$write_dir/urls_ws7e_64bit.txt"
	...
	&$_7za x -o"Standard 7 SP1 64bit IBW" "Standard 7 SP1 64bit IBW.iso"
}
...
'@ | Out-File -encoding ASCII "$write_dir/urls_ws7e_toolkit.txt"
	...
	&$_7za x -o"Standard 7 SP1 Toolkit" "Standard 7 SP1 Toolkit.iso"
}
...
&$wget --quiet --no-check-certificate --timestamping --limit-rate=2m `
	...
	&$_7za x -y -o. "MDT 2013 Documentation.zip"
}
...
'@ | Out-File -encoding ASCII "$write_dir/urls_ws7e.txt"
	...
	&$_7za x -o"Standard 7 SP1 32bit IBW" "Standard 7 SP1 32bit IBW.iso"
}
...
$wget="$write_dir/wget.exe"
$_7za="$write_dir/7za.exe"
