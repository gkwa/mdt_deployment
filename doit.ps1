...
'@ | Out-File -encoding ASCII "urls_ws7e_64bit.txt"
	...
	./wget --quiet --no-check-certificate --timestamping --limit-rate=2m `
	  --directory-prefix=$write_dir --input-file=urls_ws7e_64bit.txt
...
'@ | Out-File -encoding ASCII "urls_ws7e_toolkit.txt"
	...
	./wget --quiet --no-check-certificate --timestamping --limit-rate=2m `
	  --directory-prefix=$write_dir --input-file=urls_ws7e_toolkit.txt
...
'@ | Out-File -encoding ASCII "urls_adk.txt"
	...
	./wget --quiet --no-check-certificate --timestamping --limit-rate=2m `
	  --directory-prefix=$write_dir --input-file=urls_adk.txt
	./"adksetup.exe" /log "adksetup1.log" /quiet /features +
...
'@ | Out-File -encoding ASCII "urls_mdt.txt"
	...
	./wget --quiet --no-check-certificate --timestamping --limit-rate=2m `
	  --directory-prefix=$write_dir --input-file=urls_mdt.txt
...
'@ | Out-File -encoding ASCII "urls_wedu.txt"
	...
	./wget --quiet --no-check-certificate --timestamping --limit-rate=2m `
	  --directory-prefix=$write_dir --input-file=urls_wedu.txt
}
...
'@ | Out-File -encoding ASCII "urls_win7pro.txt"
	...
	./wget --quiet --no-check-certificate --timestamping --limit-rate=2m `
	  --directory-prefix=$write_dir --input-file=urls_win7pro.txt
}
...
'@ | Out-File -encoding ASCII "urls_mdt_taylor_made.txt"
	...
	./wget --quiet --no-check-certificate --timestamping --limit-rate=2m `
	  --directory-prefix=$write_dir --input-file=urls_mdt_taylor_made.txt
}
...
'@ | Out-File -encoding ASCII "urls_ws7e.txt"
	...
	./wget --quiet --no-check-certificate --timestamping --limit-rate=2m `
	  --directory-prefix=$write_dir --input-file=urls_ws7e.txt
